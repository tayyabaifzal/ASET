...
export default function Footer() {
    return (
        <footer>
                ...
                <div className="row">
                    <div className="col-lg-4 mb-4">
                        <div className='contact'>
                            <h1>ADDRESS</h1>
                            <p>Ameeenia Sultania Educational Trust</p>
                    ...
                    <div className="col-lg-4 mb-4">
                        <div className="map">
                            <h1>Find us here!</h1>
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d9713.241436495451!2d-1.8366811!3d52.5097222!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870bb28e1c10c01%3A0x49adb9d28408f9e4!2sAmeenia%20Sultania%20Educational%20Trust!5e0!3m2!1sen!2suk!4v1714514329937!5m2!1sen!2suk"
                                width="300"
                                height="300"
                                padding="10px"
                                style={{ border: '0' }}
            ...
            <div className="container-fluid end-center p-3">
                <p>© Copyright 2024 Ameenia Sultania Educational Trust</p>
            </div>
        </footer>
    )
}
